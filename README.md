...
**Для оценки качества методов**
1) Запускаем раздел "Поиск маркеров" с нужным типом клеток (выбираем кластер)
2) Запускаем ячейку с "референсными" генами-маркерами
3) Запускаем ячейки только для одного типа клеток (В-клетки, Т-клетки или макрофаги)
